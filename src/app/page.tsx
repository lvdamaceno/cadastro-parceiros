...
export default function page() {
  return (
    <div className="questions flex flex-col gap-5 w-full bg-gradient-to-b from-[#f85014] to-[#fb923c]">
      {/* header */}
      ...
      {/* title */}
      <section className="max-w-4xl m-auto w-full flex flex-col border-solid border border-zinc-300 rounded-lg p-5 bg-zinc-100 drop-shadow-lg">
          ...
          <div className="text w-full">
            ...
            <div className="question text-justify flex flex-col gap-5">
              ...
              <p>
                ...
                além do veículo que possui e com isso conseguiremos definir qual
                a melhor modalidade de entrega dentro do ecossistema UltraLog
                para o seu perfil para enfim entrar em contato com você e falar
            ...
            <div className="question text-justify flex flex-col gap-5">
              <ul className="text-justify list-disc ml-5">
                ...
                <li>
                  ...
                  possua mais de 1, selecione aquele que quer utilizar com maior
                  frequência!
                </li>
              </ul>
            </div>
