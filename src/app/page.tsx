      ...
      <div className="max-w-4xl p-5 flex flex-col gap-5 m-auto">
        ...
        <section className="max-w-4xl m-auto w-full flex flex-col gap-5 border-solid border border-zinc-300 rounded-lg p-5 bg-zinc-100 drop-shadow-lg">
          <div className="presentation flex flex-col gap-5  md:flex-row">
            <div className="logo">
              <Image src={tuco} width={750} alt="Logotipo da Ultralog" />
            </div>
            <div className="text w-full">
              <h1 className="text-left text-2xl font-bold mb-5">Seja Ultra!</h1>
              <div className="question text-justify flex flex-col gap-5">
                ...
                <p>
                  ...
                  montagem, se preferir esse serviço. Essas informações nos
                  ajudarão a determinar a melhor forma de integrá-lo ao
                  ecossistema UltraLog, adequando-se ao seu perfil e
                ...
                <p>
                  ...
                  alocação imediata de tarefas de entrega ou de montagem de
                  móveis. A etapa seguinte envolve o contato de nossa equipe,
                  que fornecerá orientações detalhadas sobre como proceder.
                  Solicitamos sua paciência durante esse período; nosso objetivo
                  é facilitar esse processo e entrar em contato o mais rápido
                  possível.
                </p>
                <p>
                  Agradecemos por considerar a parceria com a ultra.log.br!
                  Estamos empolgados com a possibilidade de contar com você em
                  nossa equipe, oferecendo serviços de qualidade que atendam às
                  expectativas dos nossos clientes e reforçando o compromisso
                  com a eficiência e excelência característicos da UltraLog.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text w-full">
              ...
              <div className="question text-justify flex flex-col gap-5">
                <ul className="text-justify list-disc ml-5">
                  ...
                  <li>
                    Veículo: Para os parceiros interessados em realizar
                    entregas, seu veículo pode variar de uma bicicleta até um
                    caminhão. Caso opte por utilizar veículos motorizados, é
                    necessário ter uma habilitação válida e na categoria
                    adequada para o tipo de veículo escolhido. Além disso, a
                    documentação do veículo deve estar em dia. No momento do
                    cadastro, é possível selecionar apenas 1 veículo. Se você
                    possui mais de um, escolha aquele que pretende usar com
                    maior frequência nas entregas.
                  </li>
                  <li>
                    Para montagem de móveis: Se você deseja prestar serviços de
                    montagem de móveis, não é necessário possuir um veículo. No
                    entanto, é importante ter habilidades comprovadas em
                    montagem de móveis e ferramentas adequadas para realizar o
                ...
                <p>
                  Independente da opção escolhida, seja para realizar entregas
                  ou para prestar serviços de montagem de móveis, estamos em
                  busca de parceiros comprometidos e prontos para oferecer um
