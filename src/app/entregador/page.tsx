      ...
      <div className="max-w-4xl p-5 flex flex-col gap-5 m-auto">
        <section className="flex flex-col gap-5 border-solid border border-zinc-300 rounded-lg p-5 bg-zinc-100 drop-shadow-lg">
          <h1 className="underline text-center text-2xl font-bold ">
            ULTRALOG - CADASTRO P/ PARCEIROS DE ENTREGA
          </h1>
        </section>
        <form action="" className="flex flex-col gap-5 ">
          ...
          <section className="flex flex-col gap-5 border-solid border border-zinc-300 rounded-lg p-5  bg-zinc-100 drop-shadow-lg">
            ...
            <div className="question">
              <h2 className="font-bold">
                Qual o tipo do seu veículo usado para as entregas? Escolha todas
                as opções que se aplicam:
                <span className="text-red-500">*</span>
              </h2>
              <fieldset>
                <div className="flex gap-1">
                ...
                <div className="flex gap-1">
                  <input
                    ...
                    name="meio-transporte"
                  />
                  <label htmlFor="pickup-maritima">
                    Pickup com capota marítima
                  </label>
                </div>
                <div className="flex gap-1">
                  <input
                    ...
                    name="meio-transporte"
                  />
                  <label htmlFor="pickup-fibra">
                    Pickup com capota de fibra
                  </label>
                </div>
                <div className="flex gap-1">
                  <input
